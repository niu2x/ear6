...
bool MapperFactory::is_supported(int mapper_number) {
    switch (mapper_number) {
        ...
        case 117: case 118: case 145: case 146: case 148: case 149: case 150: case 151: case 154:
        case 153: case 156: case 157: case 159:
        case 40: case 42: case 43: case 45: case 46: case 50:
        case 57:
        case 71: case 77:
        case 107:
...
BaseMapper* MapperFactory::create(int mapper_number) {
    ...
    switch (mapper_number) {
        ...
        case 21: case 22: case 23: case 25: return new MapperVRC2_4();
        case 24: case 26: return new MapperVRC6();
        ...
        case 73: return new Mapper073();
        case 74: return new Mapper074();
